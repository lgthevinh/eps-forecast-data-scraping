...
from scraping.kis.kis_scraping import scraping_kis_all
...
def main(TAG: str, size: int = None):
    ...
    scraping_kis_all(output_dir=output_dir, max_pages=37, start_page=1, firm=TAG, download_dir=download_dir)
